...
export default function Home() {
  ...
  const fileContent = content.filter(
    (item) => item.contentType.toLowerCase() === "file"
  ).length;
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-32">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/95 mb-8 sm:mb-16 max-w-4xl mx-auto leading-relaxed drop-shadow-lg font-light animate-fade-in-delay">
              Espacio virtual de auto aprendizaje para desarrollar tus
              habilidades y fortalecer tu conocimiento.
              {loading ? (
                ...
                <span className="block mt-4 text-base sm:text-lg opacity-90">
                  {content.length} contenidos disponibles • {videoContent}{" "}
                  videos • {fileContent} documentos
                </span>
              )}
            </p>
              ...
              <div className="mt-8 sm:mt-16 animate-fade-in-slow">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto px-4">
                  {availableCategories.slice(0, 4).map((category) => {
                    ...
                    const categoryContent = getContentByCategoryFiltered(
                      category.id
                    );
                    ...
                    return (
                      ...
                      >
                        <span className="relative flex flex-col items-center justify-center space-y-1 sm:space-y-2">
                          ...
                          <span className="text-center leading-tight drop-shadow-md transition-colors duration-300">
            ...
            {[
              {
                ...
                image: `${ASSETS_BASE_URL}/configuracion/images/seccion1_1.jpeg`,
              },
              {
                title: "COMPROMISO SOSTENIBLE",
                description: "Planta de producción 100% solar",
                image: `${ASSETS_BASE_URL}/configuracion/images/seccion1_2.jpeg`,
              },
              {
                title: "RIGOR CIENTÍFICO",
                description:
                  "Más de 600 pruebas en la creación de cada producto",
                image: `${ASSETS_BASE_URL}/configuracion/images/seccion1_3.jpeg`,
              },
              {
                title: "OPORTUNIDAD ÚNICA",
                description:
                  "Crea tu propio negocio compartiendo salud natural",
                image: `${ASSETS_BASE_URL}/configuracion/images/seccion1_4.jpeg`,
              },
            ].map((item, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light px-4 mb-8">
              Selecciona una categoría para explorar todo el contenido
              disponible
            </p>
          </div>
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                Cargando contenido para {selectedCountry.name}...
              </p>
            </div>
          )}
            ...
            <div className="flex flex-col items-center justify-center py-12">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-md">
                <p className="text-yellow-800 text-center">
                  No hay contenido disponible para {selectedCountry.name} en
                  este momento.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-12 sm:mb-16 leading-relaxed font-light px-4">
            Accede al conocimiento y recursos educativos de Nature's Sunshine
            diseñados especialmente para afiliados en {selectedCountry.name}
          </p>
