...
export function useContentData() {
  ...
  const [categories, setCategories] = useState([
    {
      ...
      name: "Productos",
      description:
        "Información relevante sobre los beneficios de los productos Sunshine",
      icon: "Package",
      sections: [
        {
          id: "desintoxicacion",
    ...
    },
    {
      ...
      name: "Compañía",
      description:
        "Conócenos, más de 50 años nos respaldan, avalados por un Centro de Investigación y Desarrollo propio.",
      icon: "Building",
      sections: [
        {
          id: "quienes-somos",
    ...
    },
    {
      ...
      description:
        "Estrategias, ideas, testimonios que te llevarán al éxito en tu negocio.",
      icon: "GraduationCap",
      sections: [
        {
          id: "quantum-2",
    ...
    },
    {
      ...
      name: "Shorts",
      description:
        "Videos cortos para conocer más de la marca y lo que todos están hablando.",
      icon: "Zap",
      sections: [
        {
          id: "power-start",
  ...
  const [contentItems, setInternalContentItems] = useState([
    // PRODUCTOS - Desintoxicación 90 días
    {
      ...
      description:
        "Guía paso a paso del programa de desintoxicación corporal completo de 90 días con productos Natures Sunshine",
      size: "2.4 MB",
      created_at: "2024-01-15T00:00:00.000Z",
      updated_at: "2024-01-15T00:00:00.000Z",
    },
    {
      ...
      description:
        "Tutorial paso a paso para comenzar tu programa de desintoxicación de 90 días",
      duration: "12:30",
      created_at: "2024-01-15T00:00:00.000Z",
      updated_at: "2024-01-15T00:00:00.000Z",
    },
    {
      ...
      description:
        "Testimonios reales de personas que completaron el programa de desintoxicación",
      duration: "8:45",
      created_at: "2024-01-15T00:00:00.000Z",
      updated_at: "2024-01-15T00:00:00.000Z",
    },
    ...
    // PRODUCTOS - Power Line
    {
      ...
      description:
        "Video informativo sobre productos Power Line de Nature's Sunshine",
      duration: "10:30",
      created_at: "2024-01-15T00:00:00.000Z",
      updated_at: "2024-01-15T00:00:00.000Z",
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=nw10CHXfVBk",
      description:
        "Segundo video sobre productos Power Line de Nature's Sunshine",
      duration: "8:15",
      created_at: "2024-01-15T00:00:00.000Z",
      updated_at: "2024-01-15T00:00:00.000Z",
    },
    ...
    // COMPAÑÍA - Quiénes Somos
    {
      ...
      description:
        "Manual completo sobre la historia, misión y valores de Natures Sunshine",
      size: "4.2 MB",
    ...
    },
    {
      ...
      description:
        "Reporte anual sobre nuestras iniciativas de sostenibilidad y responsabilidad social",
      size: "6.8 MB",
      created_at: "2024-01-11T00:00:00.000Z",
      updated_at: "2024-01-11T00:00:00.000Z",
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Tour por nuestras instalaciones y procesos de control de calidad",
      duration: "16:30",
      created_at: "2024-01-11T00:00:00.000Z",
      updated_at: "2024-01-11T00:00:00.000Z",
    },
    ...
    // COMPAÑÍA - Plan de Compensación
    {
      ...
      description:
        "Guía completa del plan de compensación actualizado para 2024",
      size: "1.8 MB",
    ...
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Explicación detallada de cómo funciona nuestro plan de compensación",
      duration: "25:15",
      created_at: "2024-01-12T00:00:00.000Z",
      updated_at: "2024-01-12T00:00:00.000Z",
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Testimonios de afiliados que han alcanzado el éxito financiero",
      duration: "16:40",
      created_at: "2024-01-12T00:00:00.000Z",
      updated_at: "2024-01-12T00:00:00.000Z",
    },
    ...
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Estrategias probadas para maximizar tus ingresos con el plan de compensación",
      duration: "19:25",
      created_at: "2024-01-12T00:00:00.000Z",
      updated_at: "2024-01-12T00:00:00.000Z",
    },
    ...
    },
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Entrenamiento especializado para el mercado de República Dominicana",
      duration: "16:15",
      created_at: "2024-01-14T00:00:00.000Z",
      updated_at: "2024-01-14T00:00:00.000Z",
    },
    ...
    // SHORTS - Power Start
    {
      ...
      url: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
      description:
        "Video motivacional diario para desarrollar mentalidad de éxito en afiliados",
      duration: "1:30",
  ...
  const isContentActive = (item: any) => {
    ...
    const publishDate = new Date(
      item.publish_start_date || item.publishDate || item.created_at,
    );
    const expirationDate =
      item.publish_end_date || item.expirationDate
        ? new Date(item.publish_end_date || item.expirationDate)
        : null;
  ...
  const getCategoriesForCountry = (countryCode: string) => {
    const filtered = categories
      .filter((category) => {
        ...
        const availableSections = category.sections.filter(
          (section) =>
            section.countries.includes(countryCode) ||
            section.countries.includes("all"),
        );
  ...
  const getSectionsForCountry = (countryCode: string, categoryId?: string) => {
    ...
    const filtered = sectionsToFilter.filter(
      (section) =>
        section.countries.includes(countryCode) ||
        section.countries.includes("all"),
    );
    ...
    console.log(
      `📋 Secciones para ${countryCode}${categoryId ? ` en ${categoryId}` : ""}:`,
      filtered.length,
      "elementos",
    );
    return filtered;
  ...
  const getContentStats = (countryCode: string) => {
    ...
    const videoContent = activeContent.filter(
      (item) => item.type === "youtube" || item.type === "video",
    ).length;
    const pdfContent = activeContent.filter(
      (item) => item.type === "pdf",
    ).length;
    const linkContent = activeContent.filter(
      (item) => item.type === "link",
    ).length;

    // Estadísticas por categoría
    const categoryStats = availableCategories.map((category) => {
      const categoryContent = activeContent.filter(
      ...
      return {
        ...
        totalViews: categoryContent.reduce(
    ...
    availableCategories.forEach((category) => {
      category.sections.forEach((section) => {
        const sectionContent = activeContent.filter(
          (item) =>
        ...
        if (sectionContent.length > 0) {
          sectionStats.push({
            ...
            totalViews: sectionContent.reduce(
              (sum, item) => sum + (item.views || 0),
              0,
            ),
          });
  ...
  const getContentByCategory = (categoryId: string, countryCode: string) => {
    const filtered = getContentForCountry(countryCode).filter(
      (item) => item.category === categoryId,
    );
    console.log(
      `📁 Contenido categoría ${categoryId} para ${countryCode}:`,
      filtered.length,
    );
    return filtered;
  };
  ...
  const getContentBySection = (
    ...
    const filtered = getContentForCountry(countryCode).filter(
      (item) => item.category === categoryId && item.section === sectionId,
    );
    console.log(
      `📋 Contenido sección ${sectionId} para ${countryCode}:`,
      filtered.length,
    );
    return filtered;
  };
  ...
  useEffect(() => {
    const storedCategories = localStorage.getItem(
      "universidadSunshine_categories",
    );
    const storedContent = localStorage.getItem("universidadSunshine_content");
    const storedCategoryOrder = localStorage.getItem(
      "universidadSunshine_categoryOrder",
    );
    const storedSystemConfig = localStorage.getItem(
      "universidadSunshine_systemConfig",
    );
    ...
    if (storedContent && storedContent !== "undefined") {
      try {
        ...
        if (Array.isArray(parsedContent)) {
          ...
          console.log(
            "📋 Contenido cargado desde localStorage:",
  ...
  const updateContentItems = (newContent: any[]) => {
    ...
    localStorage.setItem(
      "universidadSunshine_content",
      JSON.stringify(sortedContent),
    );
    window.dispatchEvent(
      new CustomEvent("contentDataChanged", {
  ...
  useEffect(() => {
    const handleStorageChange = (event: StorageEvent) => {
      if (event.key === "universidadSunshine_categories" && event.newValue) {
        ...
        event.key === "universidadSunshine_content" &&
        event.newValue
      ) {
        try {
        ...
        event.key === "universidadSunshine_categoryOrder" &&
        event.newValue
      ) {
        try {
        ...
        event.key === "universidadSunshine_systemConfig" &&
        event.newValue
      ) {
        try {
